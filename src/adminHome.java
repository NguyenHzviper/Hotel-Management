...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 160, 253, -1));
        ...
        jButton4.setText("Thoát"); // NOI18N
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton4ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 160, -1, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        ResultSet rs = Select.getData("select *from users where name like'%"+nameOrEmail+"%' or name like'%"+nameOrEmail+"%'");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent eve)  {
        // TODO add your handling code here:
